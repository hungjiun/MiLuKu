        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">商品分類</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
@section('inline-js')
    <script type="module">
        import {Category} from "{{asset('web_assets/js/page/product/category/category.js')}}?v=1"

        let url = '/web_api/product/category/search';

        $(document).ready(function () {
            let category = new Category(url);
            category.creteTable('#dt');
        });
    </script>
@endsection
