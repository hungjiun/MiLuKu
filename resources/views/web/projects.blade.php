                            ...
                            <td>
                                <ul class="list-inline">
                                    <li class="list-inline-item">
                                        <img alt="Avatar" class="table-avatar" src="/web_assets/dist/img/avatar.png">
                                    </li>
                                    <li class="list-inline-item">
                                        <img alt="Avatar" class="table-avatar" src="/web_assets/dist/img/avatar2.png">
                                    </li>
                                    <li class="list-inline-item">
                                        <img alt="Avatar" class="table-avatar" src="/web_assets/dist/img/avatar3.png">
                                    </li>
                                    <li class="list-inline-item">
                                        <img alt="Avatar" class="table-avatar" src="/web_assets/dist/img/avatar4.png">
                                    </li>
                                </ul>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <img alt="Avatar" class="table-avatar" src="/web_assets/dist/img/avatar5.png">
                                    </li>
                                </ul>
                            </td>
                            <td class="project_progress">
